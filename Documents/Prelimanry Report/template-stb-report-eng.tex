...
\title{\textbf{Raspberry Pi Laparoscope}\\[2ex]
       \large Mechatronic Project 478\\Progress Report\\[2ex]}                   
...
\include{chaps-main/chap-design}
\include{chaps-main/chap-heat}
\include{chaps-main/chap-test}
...
\include{chaps-append/chap-schedule}
\include{chaps-append/chap-Estcost}
\include{chaps-append/chap-GA}
\include{chaps-append/chap-drawing}
