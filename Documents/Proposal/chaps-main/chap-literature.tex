...
\vspace{0.5cm}
\noindent However, the first laparoscope has existed for almost the last century. They didn't consist of cameras, rather, out of complex lens assemblies at the end of the laparoscope and cold light sources. They were used in a similar method as a microscope. However, this severely limited the surgeon's ability to operate as well as limited the surgical staff ability to assist the head surgeon.\citep{FIS-2021} \textit{\hyperref[fig:old laparoscope]{Figure 1}} illustrates how the original laparoscope was designed.
